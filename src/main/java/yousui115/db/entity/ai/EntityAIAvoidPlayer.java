...
{
    public EntityAIAvoidPlayer(EntityCreature theEntityIn, float avoidDistanceIn, double farSpeedIn, double nearSpeedIn)
    {
        super(theEntityIn, EntityPlayer.class, avoidDistanceIn, farSpeedIn, nearSpeedIn);
    }
