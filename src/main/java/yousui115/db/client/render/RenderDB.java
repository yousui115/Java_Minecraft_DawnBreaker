...
public class RenderDB extends Render
{
     ...
     * @param renderItemIn
     */
    public RenderDB(RenderManager renderManager, RenderItem renderItemIn)
    {
        super(renderManager);
    ...
    public void doRender(Entity entityIn, double dX, double dY, double dZ, float f, float f1)
    {
        ...
        if (!(entityIn instanceof EntityDB)) { return; }
        EntityDB entitySword = ((EntityDB)entityIn);
